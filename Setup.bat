@echo off
REM ============================================================
REM  RoadX Professional Suite — first-time setup for a fresh Windows machine.
REM
REM  What this does:
...
echo.
echo =====================================================
echo   RoadX Professional Suite — setup
echo =====================================================
echo.
...
if !errorlevel! EQU 1 (
    ...
    if !errorlevel! NEQ 0 (
        ...
        echo .exe built at dist\RoadX\RoadX.exe
    )
)
...
echo =====================================================
echo   Setup complete.
echo   Double-click Launch.bat to start RoadX Professional Suite.
echo =====================================================
popd
pause
exit /b 0
