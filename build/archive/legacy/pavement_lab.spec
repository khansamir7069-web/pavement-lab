...
# DEPRECATED - Legacy PyInstaller spec for Pavement Lab.
# Retained for release history only. Do not use for active production builds.
# Use build/installer/pyinstaller.spec instead.
