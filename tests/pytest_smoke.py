...
PHASE_SMOKES: tuple[str, ...] = (
    ...
    "tests._smoke_phase17_installer",
    "tests._smoke_phase18_config_profiles",
    "tests._smoke_phase19_project_config_persistence",
    ...
    "tests._smoke_phase24_iitpave_dry_run",
    "tests._smoke_phase25_iitpave_output_contract",
    "tests._smoke_phase26_iitpave_fixture_intake",
    "tests._smoke_phase27_parser_contract_layer",
    "tests._smoke_phase28_iitpave_schema_mapping",
    "tests._smoke_phase29_iitpave_schema_corpus",
    "tests._smoke_phase30_iitpave_schema_manifest",
    "tests._smoke_phase31_iitpave_schema_report",
    "tests._smoke_phase32_iitpave_schema_workflow",
    "tests._smoke_phase33_iitpave_schema_history",
    "tests._smoke_phase34_iitpave_schema_history_review",
    "tests._smoke_phase35_iitpave_schema_history_report",
    "tests._smoke_phase36_iitpave_schema_history_selection",
    "tests._smoke_phase37_iitpave_schema_history_selection_audit",
    "tests._smoke_phase38_iitpave_schema_history_selection_audit_review",
    "tests._smoke_phase39_report_provenance",
    "tests._smoke_phase40_report_revision_snapshots",
