@echo off
REM ============================================================
REM  RoadX Professional Suite — clean rebuild of the standalone .exe.
...
if exist "%ROOT%build\RoadX" rmdir /S /Q "%ROOT%build\RoadX"
if exist "%ROOT%dist\RoadX" rmdir /S /Q "%ROOT%dist\RoadX"
...
echo.
echo Build complete: dist\RoadX\RoadX.exe
